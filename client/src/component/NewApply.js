         ...
         <Form onSubmit={(e)=>this.submitData(e)}>
                ...
                <Form.Row>                 
                   <Form.Group as={Col} controlId="formGridPassword">
                    ...
                    <Form.Control onChange={(e)=>this.getInputsData(e)} name="product" type="text" placeholder="Product" />
                    </Form.Group> 
                </Form.Row>
                ...
                <Form.Row>                 
                   <Form.Group as={Col} controlId="formGridPassword">
                    ...
                    <Form.Control  onChange={(e)=>this.getInputsData(e)} name="status" type="text" placeholder="Pending / Called / Waiting for Interview" />
                    </Form.Group> 
